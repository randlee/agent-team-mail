...
| **Z** | Z.5 | Lifecycle Logging + Hook Events | IN PROGRESS | `feature/pZ-s5-observability` |
...
| Z.5 | Lifecycle Logging + Hook Events | `feature/pZ-s5-observability` | #420, #421 | IN PROGRESS |
