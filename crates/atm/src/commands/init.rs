...
//
// Note: teammate-idle relay script is materialized for project parity, even
// when not wired by `atm init` in this command.
...
/// Merge a single hook entry into a `hooks.SessionStart` or `hooks.SessionEnd`
/// array.
///
