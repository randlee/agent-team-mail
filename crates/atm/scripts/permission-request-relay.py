#!/usr/bin/env python3
"""PermissionRequest hook relay for ATM daemon state tracking.

Marks an agent as blocked waiting on user approval.
...
def main() -> int:
    ...
    # Non-ATM sessions (no repo config and no env context) should no-op.
        ...
        send_hook_event(
            {
                ...
                "agent": agent,
                "team": team,
                "tool_name": first_str(payload.get("tool_name"), tool_input.get("name")),
